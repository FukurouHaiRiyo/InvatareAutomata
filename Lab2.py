...
# The iris dataset was chose here, splitting the classes for each species => 3 classes(0, 1, 2)
...
# for a more precise evaluation, splitting the data in train(70%) and test(30%) data
...
# train the model
ppn = Perceptron(max_iter=80, eta0=0.05, random_state=1)
...
print(f'Wrong classifications: {(y_test != y_pred).sum()}')
